...
{/* The author’s attribution link must remain intact in the templat*/}

             Designed by <a className="text-primary font-weight-bold" href="https://htmlcodex.com">HTML Codex</a>
         </p>
     </div>
 </div>
 {/*<!-- Footer End -->*/}
