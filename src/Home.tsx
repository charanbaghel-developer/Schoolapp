...
{/*<!-- Header End -->*/}
 ...
 {/* <div className="owl-carousel">
  <div className="item"><img src="/img/class-1.jpg" /></div>
  <div className="item"><img src="/img/class-2.jpg" /></div>
  <div className="item"><img src="/img/class-3.jpg" /></div>
</div> */}
 {/*<!-- Facilities Start -->*/}
  {/*<!-- About Start -->*/}
            ...
            <SwiperSlide>
             <div className="col-md-6 col-lg-3 text-center team mb-5">
                 <div className="position-relative overflow-hidden mb-4" style={{borderRadius: "100%"}}>
                     <img className="img-fluid w-1000" src="img/team-1.jpg" alt=""/>
                     <div
                         className="team-social d-flex align-items-center justify-content-center w-100 h-100 position-absolute">
                         <a className="btn btn-outline-light text-center mr-2 px-0" style={{width: "100px", height: "38px"}}
                             href="#"><i className="fab fa-twitter"></i></a>
                         <a className="btn btn-outline-light text-center mr-2 px-0" style={{width: "100px", height: "38px"}}
                             href="#"><i className="fab fa-facebook-f"></i></a>
                         <a className="btn btn-outline-light text-center px-0" style={{width:"100px", height: "38px"}}
 ...
 {/*<!-- Testimonial Start -->*/}
   {/* <Swiper
    ...
    >
      ...
      <SwiperSlide>
        <img src="/img/testimonial-2.jpg" style={{ width: "100%" }} />
      </SwiperSlide>

      <SwiperSlide>
        <img src="/img/testimonial-3.jpg" style={{ width: "100%" }} />
      </SwiperSlide>
    </Swiper> */}
<div className="container-fluid py-5">
